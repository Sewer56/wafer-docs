...
**Set up with:** [Claude Code](/wafer-pass/claude-code) · [Codex](/wafer-pass/codex) · [Conductor](/wafer-pass/conductor) · [OpenClaw](/wafer-pass/openclaw) · [Hermes Agent](/wafer-pass/hermes-agent) · [Cline](/wafer-pass/cline) · [Roo Code](/wafer-pass/roo-code) · [Kilo Code](/wafer-pass/kilo-code) · [OpenHands](/wafer-pass/openhands) · [LibreChat](/wafer-pass/librechat) · [OpenCode](/wafer-pass/opencode)
...
<Steps>
  ...
  <Step title="Start coding">
    Use the key in Claude Code, Codex, Conductor, OpenClaw, Cline, Roo Code, Kilo Code, Hermes Agent, OpenHands, OpenCode, or any other supported harness.
  </Step>
</Steps>
