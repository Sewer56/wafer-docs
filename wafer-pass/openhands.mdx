...
<Note>
  **Model string:** the examples below use `Qwen3.5-397B-A17B`. To use a different model, swap that ID for `GLM-5.1` anywhere a model ID appears. The `openai/` prefix is required — OpenHands uses litellm under the hood.
</Note>
