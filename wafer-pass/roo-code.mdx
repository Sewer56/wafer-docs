...
<Steps>
  <Step title="Install Roo Code">
    Install the [Roo Code extension] from the VS Code marketplace, or search "Roo Code" in
    VS Code Extensions.
  </Step>
...
[Roo Code extension]: https://marketplace.visualstudio.com/items?itemName=RooVetGit.Roo-Code
